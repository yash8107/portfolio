...
const initialProjects = [
    {
        ...
        repositoryUrl: "https://github.com/yash8107",
        demoUrl: "https://github.com/yash8107",
                                    ...
                                    <div className="grid grid-flow-col gap-4 mt-4">
                                        ...
                                        {project.repositoryUrl && (
                                            <button
                                                onClick={(e) => {
                                                    e.preventDefault();
                                                    window.open(project.repositoryUrl, '_blank', 'utm_source=&utm_medium=campaign&utm_campaign=portfolio');
                                                }}
