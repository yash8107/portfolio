            ...
            <div className='grid grid-flow-row gap-10 xl:grid-cols-2 xl:grid-flow-col xl:gap-0'>
                ...
                <div className='flex flex-col items-center justify-center order-2 xl:items-start xl:order-1'>
                    <motion.p
                        ...
                        aria-label="Welcome to Yash's Portfolio"
                    >
                    ...
                    <motion.p
                        ...
                        aria-label="I'm Yash Singhal. A passionate Full Stack Web Developer based in Bangalore, Karnataka, India."
                    >
                        I&apos;m Yash Singhal. A passionate Full Stack Web Developer based in Bangalore, Karnataka, India..
                    </motion.p>
                </div>
                {/* second */}
